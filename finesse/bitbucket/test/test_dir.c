...
static MunitResult test_create_dir(const MunitParameter params[] __notused, void *prv __notused)
{
...
static MunitResult test_create_subdir(const MunitParameter params[] __notused, void *prv __notused)
{
    bitbucket_inode_t *rootdir      = NULL;
...
static MunitResult test_enumerate_dir(const MunitParameter params[] __notused, void *prv __notused)
{
    bitbucket_inode_t *      rootdir = NULL;
    uint64_t                 refcount;
    bitbucket_inode_table_t *Table   = NULL;
    const char *             names[] = {
        "dog", "cat", "llama", "sheep", "pig", NULL,
    };
