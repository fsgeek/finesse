...
int         FinesseGetMessageAuxBuffer(finesse_server_handle_t FinesseServerHandle, void *Client, void *Message, void **Buffer,
                                       size_t *BufferSize);
...
int  FinesseSendNameMapReleaseResponse(finesse_server_handle_t FinesseServerHandle, void *Client, fincomm_message Message,
                                       int Result);
...
int FinesseSendPathSearchResponse(finesse_server_handle_t FinesseServerHandle, void *Client, fincomm_message Message, char *Path,
                                  int Result);
...
int  FinesseSendUnlinkRequest(finesse_client_handle_t FinesseClientHandle, uuid_t *Parent, const char *NameToUnlink,
                              fincomm_message *Message);
...
int  FinesseSendStatfsResponse(finesse_server_handle_t FinesseServerHandle, void *Client, fincomm_message Message,
                               struct statvfs *buf, int Result);
...
int  FinesseSendFstatfsResponse(finesse_server_handle_t FinesseServerHandle, void *Client, fincomm_message Message,
                                struct statvfs *buf, int Result);
...
#define FinesseSendFstatAtRquest(fch, parent, path, flags, msgptr) \
    FinesseSendCommonStatRequest(fch, parent, NULL, flags, path, msgptr)
...
int  FinesseSendAccessRequest(finesse_client_handle_t FinesseClientHandle, uuid_t *Parent, const char *Path, mode_t Mode,
                              fincomm_message *Message);
