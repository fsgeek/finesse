...
#define CHECK_FAST_TRIE_NODE_MAGIC(ftn) verify_magic("fast_trie_node_t", __FILE__, __func__, __LINE__, FAST_TRIE_NODE_MAGIC, (ftn)->Magic)
...
#define CHECK_FAST_TRIE_TABLE_MAGIC(ftt) verify_magic("fast_trie_t", __FILE__, __func__, __LINE__, FAST_TRIE_TABLE_MAGIC, (ftt)->Magic)
