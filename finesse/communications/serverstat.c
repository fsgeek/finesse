...
_Static_assert(sizeof(FinesseServerStat) < SHM_PAGE_SIZE - (offsetof(fincomm_message_block, Data) + offsetof(finesse_msg, Message.Native.Response.Parameters.ServerStat.Data)), 
...
int FinesseSendServerStatRequest(finesse_client_handle_t FinesseClientHandle, fincomm_message *Message)
{
    ...
    fmsg->Message.Native.Request.NativeRequestType = FINESSE_NATIVE_REQ_SERVER_STAT;
