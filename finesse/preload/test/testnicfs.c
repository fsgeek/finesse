...
static char *mount_prefix[] = {"", /* "/mnt/pt",*/ NULL};
static char *files[] = { "testfile1", NULL};
static char *dirs[] = { "/tmp/nicfs/dir1", NULL};
static char *file_counts[] = { "1", /* "100", "1000",  "10000",*/ NULL};
static char *test_niccolum_options[] = {TEST_NICCOLUM_OPTION_FALSE, /* TEST_NICCOLUM_OPTION_TRUE, */ NULL};

MunitParameterEnum open_params[] = 
{
    {.name = TEST_MOUNT_PREFIX, .values = mount_prefix}, 
    {.name = TEST_OPEN_FILE_PARAM_FILE, .values = files},
    {.name = TEST_OPEN_FILE_PARAM_DIR,  .values = dirs},
    {.name = TEST_FILE_COUNT, .values = file_counts},
    {.name = TEST_NICCOLUM_OPTION, .values = test_niccolum_options},
    ...
    char **argv)
{
    static MunitTest tests[] = {
        ...
        TEST("/search/path/niccolum", test_niccolum_search, NULL),
